...
@EnableJpaRepositories({
        ...
        "ru.softlab.zikova.efr.services.authorization.repositories"})
public class HibernateConfig {

    private static final String[] HIBERNATE_PACKAGES = {"ru.softlab.zikova.efr.model", "ru.softlab.zikova.efr.services.authorization.model"};
